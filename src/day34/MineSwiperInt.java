...
public class MineSwiperInt {
    public static void main(String[] args) {
        ...
        //5.а проверить каждую клеточки по гризонтали [i,j+1]и [i,j-1]
        //5.b проверить по вертикали [i-1,j] [i+1,j]
        //5.c проверить верхний левый угол [i-1,j-1]
   ...
   /* private static void checkHorizontal(int[][] field, int x, int y) {
    }*/
